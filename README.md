...
| `scan_omnifocus_inbox.py` | Scan ALL OmniFocus tasks for hashless items; route to Vault Daily Note or GitHub Issue; auto-renames OmniFocus tasks via JXA |
...
| `omnifocus_dump.txt` | Raw text output from `dump_database` MCP call; input to `scan_omnifocus_inbox.py --dump-file` |
